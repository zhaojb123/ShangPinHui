        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{'active':isOne}" @click="order('1')">
                ...
                <li :class="{'active':isTwo}" @click="order('2')">
...
export default {
  ...
  methods: {
    ...
    attrInfo (val) {
      // console.log(111)
      if (!this.searchParams.props.includes(val)) {
        this.searchParams.props.push(val)
        this.getData()
      }
    },
    // 获取页数
