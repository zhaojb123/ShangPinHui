  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="item in trademarkList" :key="item.tmId" @click="trademarkInfo(item)">{{item.tmName}}</li>
          <!-- <li>TCL</li>
          <li>长虹（CHANGHONG）</li>
          <li>飞利浦（PHILIPS）</li>
          <li>风行电视</li>
    ...
    <div class="type-wrap" v-for="item in attrsList" :key="item.attrId">
      ...
      <div class="fl value">
        <ul class="type-list">
          <li v-for="item01 in item.attrValueList" :key="item01" @click="attrInfo(item,item01)">
            <a>{{item01}}</a>
          </li>
          <!-- <li>
            <a>电信2G</a>
